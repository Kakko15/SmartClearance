...
export default function RequestCard({
  ...
  return (
    <div
      className={`spatial-glass rounded-3xl p-6 border hover:shadow-2xl hover:shadow-green-500/10 transition-all duration-300 ${isDark ? "border-slate-700/50 bg-slate-800/50" : "border-gray-200/50"}`}
    >
      {}
      ...
      <div
        className={`mb-6 p-4 rounded-2xl border ${isDark ? "bg-green-900/20 border-green-800/30" : "bg-green-50 border-green-100"}`}
      >
        <p
      ...
      <div className="mb-6">
        ...
        <div
          className={`w-full rounded-full h-3 shadow-inner ${isDark ? "bg-slate-700" : "bg-gray-100"}`}
        >
          <div
        ...
        <p
          className={`text-xs mt-2 text-right font-semibold ${isDark ? "text-gray-400" : "text-gray-500"}`}
        >
      ...
      {(request.current_status === "pending" ||
        request.current_status === "on_hold") && (
        <div
          className={`pt-6 border-t flex gap-3 ${isDark ? "border-slate-700" : "border-gray-200"}`}
        >
          {request.current_status === "on_hold" && (
            <button
