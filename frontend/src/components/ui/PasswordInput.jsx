...
export default function PasswordInput({
  ...
  // BUG 12 FIX: Use theme-aware colors for the eye icon toggle button
          className={`absolute right-3 top-1/2 -translate-y-1/2 rounded-md transition-colors hover:text-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 ${isDark ? "text-gray-500 hover:text-gray-300" : "text-gray-400 hover:text-gray-600"}`}
        >
          {showPassword ? (
            <svg
              className="w-5 h-5"
