...
export default function AuthPage({
  ...
  return (
    <div
      className={`relative flex min-h-screen flex-col p-4 overflow-x-hidden transition-colors duration-300 ${isDark ? "bg-slate-950" : "bg-[#f8fafc]"}`}
    >
      ...
      <motion.div
        ...
        className={`w-full max-w-[500px] m-auto rounded-3xl overflow-visible relative z-20 transition-all duration-300 ${isDark ? "spatial-glass-dark" : "spatial-glass"}`}
      >
        <div
